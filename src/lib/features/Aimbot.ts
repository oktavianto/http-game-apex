...
export class Aimbot {
  updateStates(levelName: string, localPlayer: app.core.Player, players: Iterable<app.core.Player>) {
    ...
    //console.log(closestEnemyPlayer);
    // const closestEnemyPlayer = this.createDummyPLayer();
    // const closestEnemyPlayer = this.findClosestEnemyPlayer(localPlayer, Array.from(players));
